  ...
  return (
    <div className="min-h-screen mx-6">
      <div className="max-w-7xl mx-auto">
        {/* Show appropriate title based on user type */}
        {isStoreOwner ? (
          <PageTitle heading="Logistics Services" text="Find delivery partners or become a logistics provider" />
        ) : (
          <PageTitle heading="Become a Logistics Provider" text="Register to provide delivery services to sellers" />
        )}
        
        {/* Conditional rendering for store owners */}
        {isStoreOwner && (
